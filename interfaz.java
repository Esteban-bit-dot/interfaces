...
public class Formulario_Registro_Vehiculo extends javax.swing.JPanel {
    ...
    private Object Campo_serial;
    private Object Campo_modelo;
    ...
    private void initComponents() {
        ...
        jTextPane1.setBackground(java.awt.Color.blue);
        ...
        jTextPane2.setBackground(java.awt.Color.blue);
        jTextPane2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextPane2.setText("Digite el Serial del Vehiculo:");
        jScrollPane3.setViewportView(jTextPane2);

        jScrollPane4.setViewportView(jTextPane3);

        jTextPane4.setBackground(java.awt.Color.blue);
        jTextPane4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextPane4.setText("Digite el modelo del Vehiculo:");
    ...
    private void BotoRegistroMouseClicked(java.awt.event.MouseEvent event) {
        System.err.println("***Se hizo click en el boton***");
        String auxserial=Campo_serial.getText(); 
        String ausmodelo = Campo_modelo.getText();
        String mostrar = formulario.getText();
}
